...
//!
//! Generalization of the validated persistent-prefix envelope
//! (`format.rs`, ATPCNV04): instead of hard-coding tokens/KV/SSM/hidden
//! sections, a record is the exact token IDs plus N opaque named regions,
//! each page-aligned and individually CRC'd. The correctness techniques
