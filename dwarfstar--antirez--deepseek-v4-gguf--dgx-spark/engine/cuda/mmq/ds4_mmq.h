...
// Runtime-local verifier dispatch override. A positive value replaces
// DS4_MMQ_D2R_MIN_COLS on the calling thread; zero restores the configured
// process default. This is scoped around one target-verifier forward.
void ds4_mmq_set_d2r_min_cols_override(int64_t min_cols);
