...
static __thread int64_t g_d2r_min_cols_override = 0;

extern "C" void ds4_mmq_set_d2r_min_cols_override(int64_t min_cols) {
    g_d2r_min_cols_override = min_cols > 0 ? min_cols : 0;
}

static int64_t d2r_min_cols() {
    if (g_d2r_min_cols_override > 0) return g_d2r_min_cols_override;
